 ...
 *
 * @deprecated since Moodle 3.9 MDL-68612 - Please use \core_user\table\participants_search along with table filtersets instead.
 * @package    core_user
...
class unified_filter implements renderable, templatable {
    ...
    public function __construct($filteroptions, $selectedoptions, $baseurl = null) {
        $deprecatedtext = 'unified_filter() is deprecated. ' .
                          'Please use \core\table\participants_search with table filtersets instead.';
