...
class participants_search {
     ...
     *
     * @param string $useridcolumn User ID column used in the calling query, e.g. eu_u.id
     * @param string $forceduseridcolumn User ID column used in any forced query, e.g. feu_u.id
