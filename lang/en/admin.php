...
$string['configenablecoursedownload'] = 'If enabled, an option to download all, or a portion of a course is available. If disabled but available, this can be enabled within each course\'s settings.';
...
$string['enablecoursedownload'] = 'Enable course download';
...
$string['maxsizepercoursedownloadfile'] = 'Maximum size per file in course downloads';
