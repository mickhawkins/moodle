...
$string['configenablecoursedownload'] = 'If enabled, an option is available within courses to download all compatible activity/resource content. If disabled but available, this will be disabled by default, but can be enabled within each course\'s settings.';
...
$string['configmaxsizepercoursedownloadfile'] = 'The maximum size of each file within a course download. Files exceeding this size will be omitted from course downloads.';
...
$string['disabledavailable'] = 'Disabled, but available';
...
$string['enablecoursedownload'] = 'Enable course content download';
...
$string['maxsizepercoursedownloadfile'] = 'Maximum size per file in course content downloads';
