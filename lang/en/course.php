...
$string['coursedownload_help'] = 'This setting determines whether course activity/resource content can be downloaded from the course homepage (for users with the capability to do so).';
