...
$string['coursedownloadconfirmation'] = 'You are about to download a zip file, which will contain all {$a->modules} content from this course (excluding any files larger than {$a->maxfilesize} {$a->filesizeunit}).';
