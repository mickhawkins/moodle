...
$string['coursedownload'] = 'Course download';
...
$string['downloadcoursecontentdesc'] = 'You are about to download a zip file containing {$a->itemcount} items, including {$a->activitylist}.';
