...
/**
 * Privacy tests for theme_classic.
 *
 * @package    theme_classic
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @copyright  Based on 2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

defined('MOODLE_INTERNAL') || die();

use \theme_classic\privacy\provider;

/**
 * Unit tests for theme_classic/classes/privacy/policy
 *
 * @package    theme_classic
 * @category   test
 * @copyright  2019 Michael Hawkins
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_classic_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $exportedpreferences = $writer->get_user_preferences('theme_classic');
        $this->assertCount(1, (array) $exportedpreferences);
        $this->assertEquals('false', $exportedpreferences->{provider::DRAWER_OPEN_NAV}->value);
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_classic'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_classic'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
