...
class matrix_user_manager {
    ...
    public static function get_matrixid_from_moodle(
        ...
        $matrixprofilefield = get_config('communication_customlink', 'matrixuserid_field');
    ...
    public static function create_matrix_user_profile_fields(): string {
        ...
        if ($matrixuserid < 1) {
            ...
            $data = (object) [
                'shortname' => 'matrixuserid',
                'name' => get_string('matrixuserid', 'communication_customlink'),
                'datatype' => 'text',
                'description' => get_string('matrixuserid_desc', 'communication_customlink'),
                'descriptionformat' => 1,
                'categoryid' => $categoryid,
                'forceunique' => 1,
                'visible' => 0,
            ...
            set_config('matrixuserid_field', 'matrixuserid', 'communication_customlink');
            return 'matrixuserid';
        }
    }
}
