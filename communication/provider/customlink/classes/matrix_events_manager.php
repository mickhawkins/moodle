...
class matrix_events_manager {
    ...
    public function __construct(?string $roomid = null) {
        ...
        $this->matrixhomeserverurl = get_config('communication_customlink', 'matrixhomeserverurl');
        $this->matrixaccesstoken = get_config('communication_customlink', 'matrixaccesstoken');
        $this->matrixwebclienturl = get_config('communication_customlink', 'matrixelementurl');
    }
