...
use communication_customlink\matrix_test_helper_trait;
...
/**
 * Class behat_communication_customlink for behat custom steps and configuration for matrix.
 *
 ...
 */
class behat_communication_customlink extends \behat_base {
     ...
     *
     * @BeforeScenario @communication_customlink
     *
