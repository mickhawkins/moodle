...
$string['issue'] = 'Issue';
$string['loading'] = 'Preparing report section ...';
$string['passedcheckstext'] = '{$a} checks in this section require no action';
$string['passedchecksshow'] = 'Click to show passed checks';
$string['passedcheckshide'] = 'Click to hide passed checks';
$string['pluginname'] = 'Security overview';
$string['section:developmentsettings'] = 'Development settings';
$string['section:developmentsettingsdescription'] = 'Settings primarily designed for development use, which should be disabled on production sites.';
$string['section:elevatedaccess'] = 'Elevated access';
$string['section:elevatedaccessdescription'] = 'These permissions should be audited from time to time to ensure users are not assigned additional access they do not require.';
$string['section:bestpractices'] = 'General best practices';
$string['section:bestpracticesdescription'] = 'Best practice measures to increase security relating to registered users.';
$string['section:outsideaccess'] = 'Outside access';
$string['section:outsideaccessdescription'] = 'Items relating to functionality access that does not require login by a registered user.';
