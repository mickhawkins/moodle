...
$string['section:elevatedaccessdescription'] = 'These permissions should be audited from time to time to ensure users are not assigned additional access they do not need.';
