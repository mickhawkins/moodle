...
class block_calendar_month extends block_base {
    ...
    public function get_content() {
        ...
        list($data, $template) = calendar_get_view($calendar, 'monthblock', isloggedin(), false, null, CALENDAR_LIMIT_DAY_EVENTS);
        ...
        $this->page->requires->js_call_amd('core_calendar/popover', 'init', [$this->instance->id]);
