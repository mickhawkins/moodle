...
Feature: View activity completion
  ...
  Scenario: View automatic completion items as a student
    ...
    TODO - below this is from another test. This one needs to progress to assessment phase etc and have a second student so we can set a proper grade etc,
     then close the workshop and check the grade.
