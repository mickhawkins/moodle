...
class custom_completion extends activity_custom_completion {
    ...
    public function get_state(string $rule): int {
        ...
        $status = $DB->record_exists('glossary_entries', ['glossaryid' => $this->cm->instance, 'userid' => $this->userid, 'approved' => 1]);
    ...
    public static function get_custom_rule_descriptions(): array {
        return [
            'completionsubmit' => get_string('completiondetail:submit', 'glossary')
        ];
    }
}
