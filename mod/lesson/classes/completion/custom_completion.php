...
class custom_completion extends activity_custom_completion {
    ...
    public function get_state(string $rule): int {
        ...
        switch ($rule) {
            ...
            case 'completionendreached':
                $status = COMPLETION_COMPLETE;//TODO - this doesn't appear to be recorded anywhere that I can find, may need to implement that.
                break;
            default:
    ...
    public function get_custom_rule_descriptions(): array {
        $timespent = format_time($this->cm->customdata['customcompletionrules']['completiontimespent']);
