...
class custom_completion extends activity_custom_completion {
    ...
    public function get_custom_rule_descriptions(): array {
        $completiondiscussions = $this->cm->customdata['customcompletionrules']['completiondiscussions'];
        $completionreplies = $this->cm->customdata['customcompletionrules']['completionreplies'];
        $completionposts = $this->cm->customdata['customcompletionrules']['completionposts'];
