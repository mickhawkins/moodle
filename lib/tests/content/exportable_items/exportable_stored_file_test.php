...
class exportable_stored_file_test extends advanced_testcase {
    ...
    public function test_create_from_area_params_in_subdir(): void {
        ...
        $exportables = exportable_stored_file::create_from_area_params($context, $component, $filearea, 2, $subdir);
    ...
    public function test_serialize_and_unserialize(): void {
        ...
        $files = $this->create_files(context_system::instance(), $component, $filearea, 1);

        $exportables = exportable_stored_file::create_from_area_params($context, $component, $filearea, 1, $subdir);
        $exportable = reset($exportables);
        ...
        $file = reset($files);
        $this->assert_exportable_matches_file($component, $user, $context, $filearea, $subdir, $file, $exportable);
    }
