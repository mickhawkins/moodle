...
function($, log, str, templates, notification, LoadingIcon) {
    ...
    return /** @alias module:core/form-autocomplete */ {
        ...
        remove: function(selector, uniqueId) {
            window.console.log('selector: ' + selector + ', uniqueid: ' + uniqueId);
            window.console.log('parent:');
            window.console.log($(selector).parent());
            window.console.log('children:');
            window.console.log($(selector).parent().children('[data-autocomplete-uniqueid="' + uniqueId + '"]'));
            window.console.log('visible thing:');
            window.console.log($(document.getElementById('form_autocomplete_input-' + uniqueId)).parent());
            window.console.log('suggestions:');
            window.console.log($(document.getElementById('form_autocomplete_suggestions-' + uniqueId)));
